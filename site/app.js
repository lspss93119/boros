...
const copy = {
  ...
  zh: {
    ...
    pageSubtitle: "查看 Boros 隐含 APR 与远期实际资金费率 APR 的对比：市场定价与最终实际资金费率的差异。",
    ...
    receivedMore: "收到更多",
    markets: "市场数",
    avgAbsGapSum: "平均绝对 Gap 总和",
    paidMoreThanReceived: "支付多于实际",
    receivedMoreThanPaid: "实际多于支付",
    dateRange: "日期范围",
    marketMap: "市场地图",
    mapSubtitle: "筛选后市场的平均隐含 APR 与远期实际 APR 对比。",
    forwardRealizedNote: "远期实际 APR 指从每个 Boros 观察日到该市场到期日之间，交易所实际资金费率 APR 的平均值。",
    market: "市场",
    loading: "加载中...",
    expired: "已到期",
    expires: "到期日",
    ...
    ohlcv: "OHLCV",
    implied: "隐含",
    forwardRealized: "远期实际",
    settlement: "隐含 vs 实际结算",
    actualSettlement: "实际结算",
    settlementApr: "实际结算 APR",
    cumulativeDiffBps: "累计差值",
    impliedFundingBps: "隐含每期资金费",
    settlementFundingBps: "实际结算每期资金费",
    settlementFrequency: "每日结算次数",
    settlementPeriods: "当日结算期数",
    forwardRealizedApr: "远期实际 APR",
    impliedApr: "隐含 APR",
    avgImplied: "平均隐含",
    avgForwardRealized: "平均远期实际",
    avgGap: "平均 Gap",
    exchangeAsset: "交易所 / 资产",
    impliedMinusForward: "隐含减远期实际",
    days: "天数",
    open: "开盘",
    high: "最高",
    low: "最低",
